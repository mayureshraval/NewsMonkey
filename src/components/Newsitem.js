...
export class Newsitem extends Component {
  render() {
    let { title, description, imageUrl, newsUrl, author, publishedAt ,content,source} = this.props;
      ...
      <>
        <div className="card" style={{ width: '24rem' }}>
          <span className="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-success" style={{zIndex:'1'}}>
             {source!==null && source!=='Google News'? source : author!==null ? author:'Unknown'}
          </span> 
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-success">
                <b>Author - {author!==null? author : 'anonymous'}</b>
              </small> <br/>
